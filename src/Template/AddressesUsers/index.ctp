    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $addressesUser->address_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $addressesUser->address_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $addressesUser->address_id], ['confirm' => __('Are you sure you want to delete # {0}?', $addressesUser->address_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
